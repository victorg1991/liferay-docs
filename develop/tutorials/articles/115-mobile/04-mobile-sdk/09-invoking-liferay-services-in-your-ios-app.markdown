...
authentication, as long as the OAuth 2 Admin app from 
[Liferay Marketplace](https://web.liferay.com/marketplace) 
is deployed to your portal. To learn how to use OAuth 2 authentication with the 
Mobile SDK, see the tutorial 
